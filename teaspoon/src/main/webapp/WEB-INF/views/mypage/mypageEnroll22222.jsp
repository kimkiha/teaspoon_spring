                          ...
                          <div id="정보입력" class="tabcontent" >
                            ...
                            <table id="table1" style="align:center; ">
                                    ...
                                    <tr>
                                        ...
                                        <td><div id="checkResult1" font-size:0.8em"></div></td>
                            ...
                            <script>
	        			   	...
	        			   	$(function(){  // 이벤트 걸고자 하는 input 요소 변수에 기록해놓기
	        			            ...
	        			            var $idInput = $("#informationForm input[name=userId]");
	        			            
	        			            $idInput.keyup(function(){
	        			          	 
	        			          	  console.log($idInput.val());
	        			  			  if($idInput.val().length >= 4){ // 적어도 아이디가 글자 이상되었을 때 본격적으로 중복체크
                            ...
                            <!-- <form id="email_certify" name="emailcertform" style="align:center"; action="email.e" method="post"> -->
                                <table style="list-style-type: disc; align:center; padding:30px; border:1px solid lightgrey;" id="ul">
                                    	<tr>
                                    		...
                                    		<td style="text-align:left;"><input type="text" id="email" name="email" placeholder="이메일" value="${email}" style="width:300px"> </td>
                                    		<td style="width: 230px;"><button type="button" id="email_btn1" >인증번호 발송</button></td>
                                    	</tr>	
                                    	<tr> 
                                        	<td style="font-size:20px; width:400px; padding-right:20px;"><li>인증번호확인</li></td>
                                       	 	<td style="text-align:left;"><input type="text" id="certified" name="certified" placeholder="인증번호" value="" style="width:300px"></td>
                         		...
                         		<!-- 3_1. 본인인증 및 회원가입 버튼-->
		                        	...
		                        	<input type="button" id="email_btn" class="btnenroll3" id="ModifyandEnroll2" value="인증완료" onclick="check();"></input> <!-- onclick="return check(); -->
		                           </div>
		                           <!-- </form> -->
